...
Producer) to render the assembled source. This reports that link plus a note on
the research tooling the skill uses (web search), which lives in the LLM host,
not this package.
"""
